...
<body>
    ...
    <!-- EayPIE -->
    <script src="backendjs/plugins/easypiechart/jquery.easypiechart.js"></script>
backend
    <!-- Sparklinbackende -->
    <script src="backendjs/plugins/sparkline/jquery.sparkline.min.js"></script>
backend
    <!-- Sparklinbackende demo data  -->
    <script src="backendjs/demo/sparkline-demo.js"></script>
